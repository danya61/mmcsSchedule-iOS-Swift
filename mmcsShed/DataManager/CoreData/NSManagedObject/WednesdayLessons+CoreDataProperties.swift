//
//  WednesdayLessons+CoreDataProperties.swift
//  
//
...
extension WednesdayLessons {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<WednesdayLessons> {
        return NSFetchRequest<WednesdayLessons>(entityName: "WednesdayLessons");
    }
